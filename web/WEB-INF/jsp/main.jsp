...
<head>
    ...
    <link href="${ pageContext.request.contextPath }/rs/skin/default/skin.css" rel="stylesheet" type="text/css"
          id="skin"/>
    <link href="${ pageContext.request.contextPath }/rs/lib/Hui-iconfont/1.0.1/iconfont.css" rel="stylesheet"
          type="text/css"/>
    <link href="${ pageContext.request.contextPath }/rs/css/style.css" rel="stylesheet" type="text/css"/>
    <!--[if IE 6]>
    <script type="text/javascript"
            src="${ pageContext.request.contextPath }/rs/lib/DD_belatedPNG_0.0.8a-min.js"></script>
    <script>DD_belatedPNG.fix('*');</script>
    <![endif]-->
    <title>玲珑舞艺系统 v1.0</title>
</head>
<body>
<header class="Hui-header cl"><a class="Hui-logo l" title="BUG研究所OA" href="/">玲珑艺术教育管理系统</a> <a class="Hui-logo-m l"
                                                                                                href="/"
                                                                                                title="V1.0"></a> <span
    ...
    <nav class="mainnav cl" id="Hui-nav">
        <ul>
            <li id="ttt" class="dropDown dropDown_click"><a href="javascript:;" class="dropDown_A"><i
                    class="Hui-iconfont">&#xe600;</i> 快速工作 <i class="Hui-iconfont">&#xe6d5;</i></a>
                <ul class="dropDown-menu radius box-shadow">
                    <c:forEach var="st" items="${shortcuts}">
                        <li><a href="javascript:;" onclick="addTab('${st.url}')"><i
                                class="Hui-iconfont">${st.icon}</i> ${st.name}</a></li>
                    </c:forEach>
                </ul>
            </li>
        </ul>
    ...
    <ul class="Hui-userbar">
        ...
        <li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">${user.user.name} <i class="Hui-iconfont">
            &#xe6d5;</i></a>
            <ul class="dropDown-menu radius box-shadow">
                ...
                <li>
                    <a href="javascript:window.location.href='${ pageContext.request.contextPath }/auth/login/loginout'">退出</a>
                </li>
            </ul>
        </li>
    ...
    <div id="Hui-tabNav" class="Hui-tabNav">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active"><span title="我的桌面" data-href="${ pageContext.request.contextPath }/auth/login/home">我的桌面</span><em></em>
                </li>
            </ul>
        </div>
