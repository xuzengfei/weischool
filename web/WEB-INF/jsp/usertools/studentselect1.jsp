     ...
     <tr  >
         <td class="va-t" colspan="2" >
             <div class="text-c">
                 ...
                 <button name="" id="sAll" class="btn btn-success" type="submit"  style="height: 25px;font-size: 11px"><i class="Hui-iconfont">&#xe676;</i>全选</button>
                 <button name="" id="qAll" class="btn btn-success" type="submit" style="height: 25px;font-size: 11px"><i class="Hui-iconfont">&#xe608;</i>取消全选</button>
	...
	if(rs.success){
		...
		$.each(data,function(i,val){
			...
			if(stObj[val.id]==val.name){
				str+=" <label class=\"\"><input type=\"checkbox\" checked=\"checked\" value=\"\" name=\"\" id=\""+val.id+"\" title=\""+val.name+"\" >"+val.name+"</label>";
			}else{
				str+=" <label class=\"\"><input type=\"checkbox\" value=\"\" name=\"\" id=\""+val.id+"\" title=\""+val.name+"\"  >"+val.name+"</label>";
			}
			if((i+1)%3==0){
				str+="</dd>";
			}
