...
<body>
<t:datagrid name="student" actionUrl="${ pageContext.request.contextPath }/web/manager/student/grade/datagrid/${cpId}" queryMode="group">
	<t:dgCol title="ID"   field="id"  hidden="true"></t:dgCol>
	<t:dgCol title="学生基本ID"   hidden="true"  field="student.id"></t:dgCol>
	<t:dgCol title="身份证（隐藏）"  field="student.idNo"  hidden="true"></t:dgCol>
	...
	<t:dgCol title="所属班级"     field="grade.name" ></t:dgCol>
	<t:dgCol title="状态" width="100"  field="isenable" replace="1_启用中,0_禁用中"></t:dgCol>
	<t:dgCol title="操作" field="opt" width="300"></t:dgCol>
	<t:dgFunOpt funname="toCons('${ pageContext.request.contextPath }/web/manager/cons?cpId=${cpId}&graId=${graId}&stId={id}&name={student.name}&idNo={student.idNo}','缴费')" title="缴费" icon="&#xe6b7;" ></t:dgFunOpt>
	...
	<t:dgFunOpt funname="openWinMax('${ pageContext.request.contextPath }/web/manager/student/grade/to/edit/${cpId}/{id}','更新')" title="更新" icon="edit" ></t:dgFunOpt>
	...
	<t:dgToolBar icon="add" title="添加资料" btClass="btn-primary" funname="openWinMax('${ pageContext.request.contextPath }/web/manager/student/grade/to/add/${cpId}/-1','添加资料')"></t:dgToolBar>
</t:datagrid>
