...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 班级管理  <a class="btn btn-success radius r mr-20"
    ...
    var setting = {
        ...
        callback: {
            beforeClick: function (treeId, treeNode) {
                $("#testIframe").attr("src", basePath + "web/manager/grade/" + treeNode.id + "?cpName=" + treeNode.name);
                return true;
            }
        }
    };
