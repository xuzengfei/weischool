package com.ws.controller.wei.st.controller.experience;
...
public class ExpeApi {
    ...
    public AjaxJson list(HttpServletRequest request, Experience experience, DataGrid<Experience> datagrid) {
        ...
        experience.setStudent(new Student(WeiStLoginUtils.getStudentSession().getStId()));
