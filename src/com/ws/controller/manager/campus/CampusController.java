...
public class CampusController {
    ...
    public AjaxJson add(Campus campus) {
        ResultCode code = this.campusService.add(campus);
    ...
    public AjaxJson edit(Campus campus) {
        ResultCode code = this.campusService.update(campus, true);
        AjaxJson j = new AjaxJson();
        switch (code) {
            case EXCEPTION:
                j = new AjaxJson("数据异常", false, ResultCode.EXCEPTION.getValue());
    ...
    public AjaxJson isenable(@PathVariable String id, @PathVariable Integer status) {
        ...
        ResultCode code = this.campusService.update(campus, false);
        switch (code) {
            case EXCEPTION:
                j = new AjaxJson("数据异常", false, ResultCode.EXCEPTION.getValue());
                break;
